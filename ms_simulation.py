...
from video_distillation.ms_guidance import ModelscopeGuidance
...
if __name__ == "__main__":
    ...
    for batch in range(50):
        ...
        guidance_out = guidance(img_list, prompt_utils, torch.Tensor([camera_params['init_elevation']]), torch.Tensor([camera_params['init_azimuthm']]), torch.Tensor([camera_params['init_radius']]), rgb_as_latents=False, num_frames=frame_per_stage, train_dynamic_camera=True)
